...
val confluentTopicName = "abq-litmus-cov"
...
outDf.writeStream.format("delta").outputMode("append").option("checkpointLocation", "abfss://nbl@dlsniagara.dfs.core.windows.net/checkpoints/databricks-poc/abq").toTable("databricks_poc.bronze_abq_litmus")
